...
<link rel="stylesheet" href="../../js-plugins/bootstrap-toggle-master/css/bootstrap2-toggle.min.css" />
<script src="../../js-plugins/bootstrap-toggle-master/js/bootstrap2-toggle.js"></script>
<style>
@page {
	margin-top: 0.3cm;
	margin-left: 0.3cm;
