...
<%
	...
	String decimales 		= aca.ciclo.CicloPromedio.getDecimales(conElias, cicloId, promedioId);
	...
	ArrayList<aca.kardex.KrdxAlumConducta> lisEvals		= krdxAlumConductaL.getListAll(conElias, "WHERE CICLO_GRUPO_ID = '"+cicloGrupoId+"' AND PROMEDIO_ID = "+promedioId);		
%>
...
<div id="content">
	...
	<small>
		<fmt:message key="aca.Evaluacionn"/> <%=promedioId %> | 
