 	...
 	<form action="accion.jsp?PlanId=<%=planId %>" method="post" name="frmPlan">
        ...
        <fieldset>
        	...
        	<select name="Titulo" id="Titulo">
				<option value="Grado" <%if(Plan.getTitulo().equals("Grado"))out.print("selected");%>><fmt:message key="aca.Grado" /></option>
				<option value="Semestre" <%if(Plan.getTitulo().equals("Semestre"))out.print("selected");%>><fmt:message key="aca.Semestre" /></option>
				<option value="Cuatrimestre" <%if(Plan.getTitulo().equals("Cuatrimestre"))out.print("selected");%>><fmt:message key="aca.Cuatrimestre" /></option>
				<option value="Trimestre" <%if(Plan.getTitulo().equals("Trimestre"))out.print("selected");%>><fmt:message key="aca.Trimestre" /></option>
			</select>
        </fieldset>
