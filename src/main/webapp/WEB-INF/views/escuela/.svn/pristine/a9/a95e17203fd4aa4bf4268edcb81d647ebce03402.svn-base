...
public class FinCalculo {
	...
	public boolean insertReg(Connection conn) throws SQLException{
        ...
        try{
            ...
            System.out.println("Error - aca.financiero.FinCalculo|insertReg|:" + ex);
        }finally{
            if(ps != null){
                ps.close();
            }
    ...
    public boolean updateReg(Connection conn) throws SQLException{
        ...
        try{
            ...
            System.out.println("Error - aca.financiero.FinCalculo|updateReg|:" + ex);
        }finally{
        	if(ps != null){
                ps.close();
            }
    ...
    public boolean updateFolio(Connection conn ) throws SQLException{
        ...
        try{
            ...
            System.out.println("Error - aca.financiero.FinCalculo|updateFolio|:" + ex);
        }finally{
        	if(ps != null){ ps.close(); }
        }
    ...
    public boolean deleteReg(Connection conn) throws SQLException{
        ...
        try {
            ...
            System.out.println("Error - aca.financiero.FinCalculo|deleteReg|:" + ex);
        }finally{        	
        	if(ps != null){ ps.close(); }
        }
    ...
    public void mapeaRegId(Connection con, String cicloId, String periodoId, String codigoId) throws SQLException{
        ...
        try{
			...
			System.out.println("Error - aca.financiero.FinCalculo|mapeaRegId|:"+ex);
			ex.printStackTrace();
		}finally{
			if (rs!=null) rs.close();
			if (ps!=null) ps.close();
    ...
    public boolean existeReg(Connection conn) throws SQLException {
        ...
        try {
            ...
            System.out.println("Error - aca.financiero.FinCalculo|existeReg|:" +ex);
        }finally{
        	if(rs != null){ rs.close(); }
            if(ps != null){ ps.close(); }
        }
    ...
    public String maxReg(Connection conn, String cicloId, String periodoId) throws SQLException {
        ...
        try {
            ...
            System.out.println("Error - aca.financiero.FinCalculo|maxReg|:" +ex);
        }finally{
        	if(rs != null){ rs.close(); }
            if(ps != null){ ps.close(); }
        }
