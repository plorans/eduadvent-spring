...
<div id="foro">
	...
	<section v-if="permitido" class="lista-comentarios">
	    <div v-for="comentario in comentarios" class="comentario" :id="comentario.id">
			...
			<div class="contenido">
	           <div class="encabezado">
				  	...
				  	<p>{{ mapearFecha(comentario.createdAt) }}
