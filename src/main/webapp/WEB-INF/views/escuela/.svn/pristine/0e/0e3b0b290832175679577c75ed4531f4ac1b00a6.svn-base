...
<%
	...
	if (codigoEmp.substring(3,4).equals("E")) {
		tipo = "Empleado";
	}else{
		tipo = "NO EMPLEADO";
	}
...
<div id="content">
	...
	<form action="empleado.jsp" method="post" name="frmEmpleado">
		<input name="Accion" type="hidden" value="1" />	
	
		<div class="well" style="overflow:hidden;">
			<a href="datos.jsp" class="btn btn-primary"><i class="icon-file icon-white"></i> <fmt:message key="boton.Nuevo" /></a>
		</div>
