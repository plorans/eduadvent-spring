...
<%
	...
	try{
        ...
        for(int i = 1; i <= cantidad; i++){
			...
			Image jpg = null;			
			jpg = Image.getInstance(application.getRealPath("/empleado/credencial/fondos/")+"/empleadoFrente4.jpg");
			jpg.scaleAbsolute(250f, 150f);
			jpg.setAbsolutePosition(50, 600+extra);
			document.add(jpg);
			
			jpg = Image.getInstance(application.getRealPath("/empleado/credencial/fondos/")+"/empleadoReverso4.jpg");
			jpg.scaleAbsolute(250f, 150f);
			...
			jpg.setAbsolutePosition(65, 615+extra);
			document.add(jpg);
...
/* 			boolean tieneFirma = false;
			...
			dataTable.writeSelectedRows(0, 2, 130, 664+extra, pdf.getDirectContent());
