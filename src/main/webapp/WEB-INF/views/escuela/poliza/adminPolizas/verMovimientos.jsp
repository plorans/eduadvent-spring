...
<%
	...
	String escuelaId 	= polizaId.substring(0,3);
	String usuario 		= (String)session.getAttribute("codigoId");
	
	ArrayList<aca.fin.FinMovimientos> movimientos = FinMovimientosLista.getAllMovimientosPolizaEstadoEscuela(conElias, escuelaId, polizaId, " ORDER BY RECIBO_ID DESC, FECHA DESC ");
%>
...
<div id="content">
	...
	<div class="well">
		<a href="poliza.jsp?escuelaId=<%=escuelaId %>" class="btn btn-primary">
