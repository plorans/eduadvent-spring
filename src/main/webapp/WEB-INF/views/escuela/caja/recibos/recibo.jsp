...
//		System.out.println(application.getRealPath());
		...
		cell = new PdfPCell(new Phrase((N2t.convertirLetras(Integer.parseInt(importe.substring(0, importe.indexOf("."))))).toUpperCase()+" PESOS "+importe.substring(importe.indexOf(".")+1, importe.length())+"/100 M.N.", FontFactory.getFont(FontFactory.HELVETICA, 10, Font.NORMAL, new Color(0,0,0))));
