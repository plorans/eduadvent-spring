						...
						if(kardex.getTipoCalId().equals("1")||kardex.getTipoCalId().equals("6")){
							if (treeProm.containsKey(cicloGrupo.getCicloGrupoId()+cicloGrupoCurso.getCursoId()+kardex.getCodigoId())){
								...
								if(Ciclo.getRedondeo().equals("T")){
									prom = new BigDecimal(prom.toString()).setScale(Integer.valueOf(Ciclo.getDecimales()), RoundingMode.DOWN);
								} else{
									prom = new BigDecimal(prom.toString()).setScale(Integer.valueOf(Ciclo.getDecimales()), RoundingMode.HALF_UP);
								}
