...
<div id="obsBox" class="modal hide fade" tabindex="-1" role="dialog"
	...
	<div class="modal-body ">
		<table style="width: 100%">
			<tr>
				<td style="width: 50%"><label for="asunto">Fortalezas</label> <input
					type="text" name="observacion" id="observacion"
					onkeyup="mok(this);"> <br> <span
					style="font-size: 8px">La observación tiene que ajustarse a
						9 lineas para que pueda aparecer correctamente en el boletín</span> <input
			...
			<tr>
				<td style="width: 50%"><label for="asunto">Cómo ayudar</label>
					<input type="text" name="observacion2" id="observacion2"
					onkeyup="mok(this);"> <br> <span
					style="font-size: 8px">La observación tiene que ajustarse a
						9 lineas para que pueda aparecer correctamente en el boletín</span></td>
				<td>
					<div id="divMok" style="width: 72px; font-size: 8px"></div>
				</td>
			</tr>
