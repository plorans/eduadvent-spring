	...
	<table class="table table-condensed table-bordered">
		...
		for(int i=0; i<archivosEnviados.size(); i++){
			...
			<%
				...
				%>
					<a href="../alumno/descargar.jsp?Ruta=<%=application.getRealPath("/WEB-INF/archivos")+"/"+String.valueOf(session.getAttribute("escuela"))+"/"+codigoIdAlum+"/"+codigoIdAlum+"-"+folio+"."+ext%>&nombreArchivo=<%=codigoIdAlum+"-"+folio+"."+ext%>">
