...
<!-- ESCRIBIR MENSAJE -->
 	<form action="mensaje.jsp" method="post" name="frmmsj" target="_self" style="margin:0;">
		...
		<input type="hidden" name="CodigoEmpleado" id="CodigoEmpleado" value="<%=maestroId%>">
		<input type="hidden" name="CodigoId" id="CodigoId" value="<%=codigoId%>">
	...
	<!-- MODAL -->
		<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		  ...
		  <div class="modal-footer">
		    ...
		    <a class="btn btn-primary" href="javascript:mensajeriaAjax()"><i class="icon-envelope icon-white"></i> <fmt:message key="boton.EnviarMensaje" /></a>
		  </div>
		</div>
	<!-- END MODAL -->
	</form>
...
<script>
	...
	function mensajeriaAjax(){
		var datadata = 'envia_mensaje=true&envia='+$('#CodigoEmpleado').val()+'&tipo_destino=P&destino='+$('#CodigoId').val()+'&asunto='+$('#asunto').val()+'&mensaje='+$('#Comentario').val();
		$.ajax({
