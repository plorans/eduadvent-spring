...
<body>
	<table width="100%">
		<tr>
			<td><a href="opcion.jsp" class="btn"><fmt:message key="boton.Regresar" /></a></td>
		</tr>
		<tr>
	...
	<table width="70%" class="table table-bordered table-condensed table-striped" align="center">
	  <tr>
	    <th align="center"># <fmt:message key="aca.Evaluacionn" /></th>
	    <th align="center"><fmt:message key="aca.Nombre" /></th>
...
%>
					<tr>
						...
						<td width="20%" style="background-color: #5FB404;font-weight: bold;" align="center"><font color="white"><fmt:message key="aca.Valor" /> (%)</font></td>
					</tr>
<%
				}
%>
