...
<div id="content">
	...
	<div class="alert alert-info">
		<strong><fmt:message key="aca.Maestro" />:</strong>&nbsp; <%= aca.empleado.EmpPersonal.getNombre(conElias,maestro,"NOMBRE") %>
	</div>
...
<%	
	for (int i=0;i<lisModulo.size();i++){
		...
		if (Modu.equals("0") && i==0) Modu = mod.getModuloId(); 
%>		
		  <a class="btn btn-info <%if(Modu.equals(mod.getModuloId()))out.print("active"); %>" href="modulo.jsp?ModuloId=<%=mod.getModuloId()%>"> <%=i+1%></a>
<%	}%>  
  	</div>
