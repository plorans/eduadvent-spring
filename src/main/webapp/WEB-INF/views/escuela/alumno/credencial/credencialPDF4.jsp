...
<%
	...
	try{
		String dir = application.getRealPath("/alumno/credencial/")+"/"+"credencial4.pdf";
        ...
        for(int i = 1; i <= cantidad; i++){
			...
			Image jpg = null;
			jpg = Image.getInstance(application.getRealPath("/alumno/credencial/fondos/")+"/alumnoFrente4.jpg");
			...
			jpg = Image.getInstance(application.getRealPath("/alumno/credencial/fondos/")+"/alumnoReverso4.jpg");
			jpg.scaleAbsolute(250f, 150f);
		    ...
		    jpg.scaleAbsolute(61f, 82f);
			jpg.setAbsolutePosition(45, 575+extra);
			document.add(jpg);
...
*/			
			...
			dataTable.writeSelectedRows(0, -1, 141, 625+extra, pdf.getDirectContent());
...
%>
<head>
	<meta http-equiv='REFRESH' content='0; url=credencial4.pdf'>
</head>
