...
public class FinReciboDet {
	...
	public boolean insertReg(Connection conn) throws SQLException{
        ...
        try{
            ...
            System.out.println("Error - aca.fin.FinReciboDet|insertReg|:" + ex);
        }finally{
        	if(ps != null){
                ps.close();
            }
    ...
    public boolean updateReg(Connection conn) throws SQLException{
        ...
        try{
            ...
            System.out.println("Error - aca.fin.FinReciboDet|updateReg|:" + ex);
        }finally{
        	if(ps != null){
                ps.close();
            }
    ...
    public boolean deleteReg(Connection conn) throws SQLException{
        ...
        try {
            ...
            System.out.println("Error - aca.fin.FinReciboDet|deleteReg|:" + ex);
        }finally{
        	if(ps != null){
                ps.close();
            }
    ...
    public void mapeaRegId(Connection con, String reciboId, String folio) throws SQLException{
        ...
        try{
			...
			System.out.println("Error - aca.fin.FinReciboDet|mapeaRegId|:"+ex);
			ex.printStackTrace();
		}finally{
			if (rs!=null) rs.close();
			if (ps!=null) ps.close();
    ...
    public boolean existeReg(Connection conn) throws SQLException {
        ...
        try {
            ...
            System.out.println("Error - aca.fin.FinReciboDet|existeReg|:" +ex);
        }finally{
	        if(rs != null) rs.close();
	        if(ps != null) ps.close();
        }
    ...
    public String maxReg(Connection conn, String reciboId) throws SQLException {
        ...
        try {
            ...
            System.out.println("Error - aca.fin.FinReciboDet|maxReg|:" +ex);
        }finally{
	        if(rs != null) rs.close();
	        if(ps != null) ps.close();
        }
