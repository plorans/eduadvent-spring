...
public class FinMovimiento {
	...
	public boolean insertReg(Connection conn ) throws SQLException{
		...
		try{
			...
			System.out.println("Error - aca.financiero.FinMovimiento|insertReg|:"+ex);
		}finally{
			if (ps!=null) ps.close();
		}
		return ok;
	...
	public boolean updateReg(Connection conn ) throws SQLException{
		...
		try{
			...
			System.out.println("Error - aca.financiero.FinMovimiento|updateReg|:"+ex);
		}finally{
			if (ps!=null) ps.close();
		}
		return ok;
	...
	public boolean deleteReg(Connection conn ) throws SQLException{
		...
		try{
			...
			System.out.println("Error - aca.financiero.FinMovimiento|deleteReg|:"+ex);
		}finally{
			if (ps!=null) ps.close();
		}
		return ok;
	...
	public boolean deleteMovtosAlumno(Connection conn, String codigoId, String cicloId, String periodoId ) throws SQLException{
		...
		try{
			...
			System.out.println("Error - aca.financiero.FinMovimiento|deleteMovtosAlumno|:"+ex);
		}finally{
			if (ps!=null) ps.close();
		}
		return ok;
	...
	public void mapeaRegId(Connection con, String codigoId, String folio) throws SQLException{
		...
		try{
			...
			System.out.println("Error - aca.financiero.FinMovimiento|mapeaRegId|:"+ex);
			ex.printStackTrace();
		}finally{
			if (rs!=null) rs.close();
			if (ps!=null) ps.close();
	...
	public boolean existeReg(Connection conn) throws SQLException{
		...
		try{
			...
			System.out.println("Error - aca.financiero.FinMovimiento|existeReg|:"+ex);
		}finally{
			if (rs!=null) rs.close();
			if (ps!=null) ps.close();
		}
	...
	public static String maxReg( Connection conn, String codigoId) throws SQLException{		
		...
		try{
			...
			System.out.println("Error - aca.financiero.FinMovimiento|maxReg|:"+ex);
		}finally{
			if (rs!=null) rs.close();
			if (ps!=null) ps.close();
		}
	...
	public static boolean movtosGrabados( Connection conn, String codigoId, String cicloId, String periodoId) throws SQLException{		
		...
		try{
			...
			System.out.println("Error - aca.financiero.FinMovimiento|movtosGrabados|:"+ex);
		}finally{
			if (rs!=null) rs.close();
			if (ps!=null) ps.close();
		}
	...
	public static double saldoAlumno( Connection conn, String codigoId, String fecha ) throws SQLException{
		...
		try{
			...
			System.out.println("Error - aca.financiero.FinMovimiento|saldoAlumno|:"+ex);
		}finally{
			if (rs!=null) rs.close();
			if (ps!=null) ps.close();
		}
