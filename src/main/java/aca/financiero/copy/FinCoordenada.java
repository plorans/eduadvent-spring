...
public class FinCoordenada {
	...
	public boolean insertReg(Connection conn) throws SQLException{
        ...
        try{
            ...
            System.out.println("Error - aca.financiero.FinCoordenada|insertReg|:" + ex);
        }finally{
        	if(ps!=null) ps.close();
        }
    ...
    public boolean updateReg(Connection conn) throws SQLException{
        ...
        try{
            ...
            System.out.println("Error - aca.financiero.FinCoordenada|updateReg|:" + ex);
        }finally{
        	if(ps!=null)ps.close();
        }
    ...
    public boolean deleteReg(Connection conn) throws SQLException{
        ...
        try {
            ...
            System.out.println("Error - aca.financiero.FinCoordenada|deleteReg|:" + ex);
        }finally{
        	if(ps!=null)ps.close();
        }
    ...
    public void mapeaRegId(Connection con, String usuario, String tipo) throws SQLException{
        ...
        try{
			...
			System.out.println("Error - aca.financiero.FinCoordenada|mapeaRegId|:"+ex);
			ex.printStackTrace();
		}finally{
			if (rs!=null) rs.close();
			if (ps!=null) ps.close();
    ...
    public boolean existeReg(Connection conn) throws SQLException {
        ...
        try {
            ...
            System.out.println("Error - aca.financiero.FinCoordenada|existeReg|:" +ex);
        }finally{
	        if(rs!=null)rs.close();	
	        if(ps!=null)ps.close();
        }
