...
public class FinCosto {	
	...
	public boolean insertReg(Connection conn) throws SQLException{
        ...
        try{
            ...
            System.out.println("Error - aca.financiero.FinCosto|insertReg|:" + ex);
        }finally{
        	if(ps != null){
                ps.close();
            }
    ...
    public boolean updateReg(Connection conn) throws SQLException{
        ...
        try{
            ...
            System.out.println("Error - aca.financiero.FinCosto|updateReg|:" + ex);
        }finally{
        	if(ps != null){
                ps.close();
            }
    ...
    public boolean deleteReg(Connection conn) throws SQLException{
        ...
        try {
            ps = conn.prepareStatement(
                    "DELETE FROM FIN_COSTO WHERE CICLO_ID = ? AND COSTO_ID = TO_NUMBER(?, '999')");
            ...
            System.out.println("Error - aca.financiero.FinCosto|deleteReg|:" + ex);
        }finally{
            if(ps != null) ps.close();
        }
    ...
    public void mapeaRegId(Connection con, String cicloId, String costoId) throws SQLException{
        ...
        try{
			...
			System.out.println("Error - aca.financiero.FinCosto|mapeaRegId|:"+ex);
			ex.printStackTrace();
		}finally{
			if (rs!=null) rs.close();
			if (ps!=null) ps.close();
    ...
    public boolean existeReg(Connection conn) throws SQLException {
        ...
        try {
            ...
            System.out.println("Error - aca.financiero.FinCosto|existeReg|:" +ex);
        }finally{
	        if(rs != null){
	            rs.close();
	        }
    ...
    public boolean existeCuenta(Connection conn) throws SQLException {
        ...
        try {
            ps = conn.prepareStatement("SELECT * FROM FIN_COSTO WHERE CICLO_ID = ? AND PERIODO_ID = TO_NUMBER(?, '99') AND CLASFIN_ID = ? AND PLAN_ID = ? AND CUENTA_ID = ?");
            ps.setString(1, cicloId);
            ps.setString(2, periodoId);
            ps.setString(3, clasFinId);
            ps.setString(4, planId);
    ...
    public static boolean existeSoloCuenta(Connection conn,String cuentaId) throws SQLException {
        ...
        try {
            ...
            System.out.println("Error - aca.financiero.FinCosto|existeSoloCuenta|:" +ex);
        }finally{
	        if(rs != null){
	            rs.close();
	        }
    ...
    public static boolean tieneDatos(Connection conn, String cicloId, String costoId) throws SQLException {
        ...
        try {
            ...
            System.out.println("Error - aca.financiero.FinCosto|tieneDatos|:" +ex);
        }finally{
	        if(rs != null) rs.close();
	        if(ps != null) ps.close();
        }
    ...
    public static boolean existenDatos(Connection conn, String cicloId, String periodoId, String cuentaId, String clasFin, String planId ) throws SQLException {
        ...
        try {
            ...
            System.out.println("Error - aca.financiero.FinCosto|existenDatos|:" +ex);
        }finally{
	        if(rs != null) rs.close();
	        if(ps != null) ps.close();
        }
